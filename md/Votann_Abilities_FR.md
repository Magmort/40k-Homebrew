...
*Les chefs de guerre Kin apprennent à projeter l'Œil des Ancêtres, jugeant rapidement quels ennemis méritent d'être prioritairement détruits.*

Condition : toutes les unités de votre armée ont le mot-clé VOTANN et appartiennent à la même Ligue (sauf NON-ALIGNÉ).

**Acquisition de jetons de Jugement (max 3 par unité ennemie) :**

  - Une unité ennemie détruit une unité VOTANN de votre armée : +1 jeton.

  - Une unité ennemie réussit une action d'objectif ou une action psychique : +1 jeton.

  - Fin de chaque tour : chaque unité ennemie à portée d'un objectif qu'elle contrôle gagne +1 jeton.

**Gestion des jetons lors des déplacements :**

  - Unité retirée du champ (embarquement, Réserves Stratégiques, etc.) : notez ses jetons. Quand elle revient, elle les récupère.
...
*Les Kin avancent avec un sens du but inébranlable, d'une progression régulière et délibérée.*

  - Toutes les unités Votann peuvent ignorer tout modificateur négatif à leur caractéristique de Mouvement.
...
*L'armure du vide est composée de segments durcis et articulés, tissés de fibres magnaferrite, souvent renforcés d'adamantine et équipés de micro-générateurs de champ.*
  ...
  - Chaque attaque allouée à une figurine Votann de cette unité : la PA de cette attaque est réduite de 1 (minimum 0).

Règles de Détachement

Un Détachement VOTANN ne contient que des figurines avec le mot-clé VOTANN (sauf NON-ALIGNÉ).
...
*La tradition veut qu'un seul Kahl dirige chaque Oathband, servant de stratège et de figure inspirante. Son effet est optimal quand il est au cœur du dispositif plutôt qu'isolé.*
...
Condition : toutes les unités VOTANN de votre armée appartiennent à la même Ligue.
...
*Condition : toutes les unités VOTANN de votre armée appartiennent à la même Ligue. Si toutes les unités \<LIGUE\> d'un Détachement VOTANN sont de la même Ligue, ce Détachement est appelé Détachement de Ligue.*
...
| **Relique Ancestrale de Ligue**                                                                                                                              | Si votre Seigneur de Guerre est un VOTANN \<LIGUE\>, vous pouvez donner la Relique Ancestrale de Ligue associée à un personnage VOTANN \<LIGUE\> à la place d'une Relique Ancestrale standard. Personnages nommés et IRONKIN ASSISTANT exclus. |
| *Note : si une Relique remplace un équipement existant, payez quand même son coût en points. Notez toutes les Reliques Ancestrales sur votre liste d'armée.* |                                                                                                                                                                                                                                                |

**Les Ligues**

*Pour chaque Ligue : Coutume (dont 1 règle Jugement Ancestral active si toute l'armée est de la même Ligue), Trait de SdG, Stratagème et Relique Ancestrale.*
...
GREATER THURIAN LEAGUE uniquement.
  ...
  - Chaque attaque allouée au porteur : PA réduite de 1 (min 0). Cumulable avec le bonus de l'Armure du Vide.
...
GRIMNYR TRANS-HYPERIAN ALLIANCE uniquement.
  ...
  - Tant que l'unité contient 1+ modèle CORV : le porteur peut tenter de contrer 1 action psychique supplémentaire par phase d'Action.

  - Tant que l'unité contient 1+ modèle CORV : +1 aux tests de Refus du Sorcier du porteur.
...
YMYR CONGLOMERATE avec une sauvegarde invulnérable uniquement.
  ...
  - Le porteur possède la capacité [Insensible à la douleur 4+] contre les blessures mortelles.
...
| **Priorité au Corps-à-Corps**      | *Jugement Ancestral* | Lors d'une déclaration de charge contre une seule cible avec 1+ jeton de Jugement : +2 au jet de charge.                                                                                                                                                 |
| **Stoïques**                       | *Standard*           | Relancez les tests d'Ébranlement ratés pour cette unité.                                                                                                                                                                                                 |
| **Le Prendre Personnellement**     | *Jugement Ancestral* | Si toutes les attaques d'une unité ciblent la même unité ennemie et qu'elle survit : lancez 1D6 (+1 si la cible est égal ou sous la moitié de ses effectifs). Sur 5+, la cible gagne 1 jeton de Jugement.                                                |
| **Honneur dans l'Effort**          | *Standard*           | Si l'unité est égal ou en dessous de son Effectif de Départ : +1 au jet de touche pour chaque attaque.                                                                                                                                                   |
| **Chants de Guerre**               | *Standard*           | Attaque de mêlée, si la cible est à portée d'Engagement de 2+ unités \<LIGUE\> INFANTERIE, MARCHEUR ou MONTÉ : relancez le jet de touche.                                                                                                                |
| **Ligue Affiliée**                 | *Spéciale*           | Choisissez une des 5 Ligues existantes et utilisez sa Coutume. Accès aussi au Trait de SdG et au Stratagème de cette Ligue (les mots-clés de Ligue sont remplacés par ceux de votre Ligue). EXCLUSIF : ne peut pas être combinée avec d'autres Coutumes. |
| **Noyaux de Puissance Affinés**    | *Standard*           | \+2" au Mouvement des modèles VÉHICULE.                                                                                                                                                                                                                  |
| **Prompt à Juger**                 | *Jugement Ancestral* | Après que l'unité avec cette Coutume a subi 1+ pertes sans être détruite : lancez 1D6 (+1 si l'unité est égal ou sous la moitié de ses effectifs). Sur 4+, l'unité attaquante gagne 1 jeton de Jugement.                                                 |
| **Capaciteurs à Rayon Supérieurs** | *Standard*           | \+1 à la Force de toutes les armes Rayon (Beam) (y compris Reliques). Vous pouvez jouer gratuitement le stratagème « Schéma de Tir Perce-Cœur » sur cette unité.                                                                                         |
| **Discipline Indéfectible**        | *Jugement Ancestral* | Attaque contre une cible avec 1+ jeton de Jugement : ignorez tout modificateur aux jets de touche, à la CC et à la CT.                                                                                                                                   |
| **Durci au Vide**                  | *Standard*           | Les jets de blessure non modifié de 1 ou 2 : sont automatiquement raté, quelles que soient les capacités de l'attaquant.                                                                                                                                 |
...
*Chaque amélioration augmente le coût en points de l'unité (en partie équilibrée ou avec une limite de points) du montant indiqué dans la table ci-dessous. Notez chaque amélioration sur votre feuille d'armée. Ces unités restent considérées comme la même fiche technique pour les règles de mission limitant le nombre de fois qu'une fiche peut être incluse.*

*Chaque amélioration donne à un modèle PERSONNAGE de l'unité un nouveau mot-clé (colonne Mot-clé), l'accès à des Traits de Seigneur de Guerre spécifiques, et deux capacités supplémentaires dont une capacité de Jugement Ancestral. Un modèle ne peut utiliser sa capacité de Jugement Ancestral que si toutes les unités de votre armée ont le mot-clé VOTANN (hors modèles NON-ALIGNÉ) et appartiennent à la même Ligue. Lors de l'amélioration, remplacez toutes les occurrences du mot-clé \<LIGUE\> dans les nouvelles capacités et le Trait de Seigneur de Guerre par le nom de la Ligue du modèle.*

*Une force de Croisade ne peut pas débuter avec des unités PERSONNAGE améliorées : pour en inclure une, utilisez la Réquisition « Un Grand Honneur ».*

*Une armée (et une force de Croisade) ne peut pas contenir plus d'un modèle de la même Ligue partageant le même mot-clé du Conseil Votannic (ex. pas deux GREATER THURIAN LEAGUE HIGH KÂHL, ni deux KRONUS HEGEMONY LORD GRIMNYR).*
...
**Trait de SdG : Maître Armurier**
  ...
  - Chaque fois que ce SEIGNEUR DE GUERRE répare un modèle avec sa capacité Guilde du Brôkhyr, le modèle réparé récupère jusqu'à 3 Points de Vie perdus au lieu de D3 (jusqu'à 4 si l'unité de ce BRÔKHYR FORGE-MASTER comprend 1 modèle E-COG ou plus, cf. capacité Soutien E-COG). De plus, une fois par round de bataille, quand une sauvegarde échoue pour un modèle ami \<LIGUE\> VÉHICULE ou \<LIGUE\> EXO-FRAME à 6" ou moins de ce SEIGNEUR DE GUERRE, celui-ci peut utiliser ce Trait : la caractéristique de Dégâts de cette attaque devient 0.

## **Discipline Skeinwrought**

*Avant la bataille, générez les actions psychiques des modèles PSYKER de votre armée qui connaissent des pouvoirs de la discipline Skeinwrought à l'aide de la table ci-dessous. Vous pouvez soit lancer 1D6 pour générer chaque pouvoir aléatoirement (relancez les doublons), soit choisir les pouvoirs que connaît le psyker.*

*Quand un modèle PSYKER de votre armée lance une action psychique de cette discipline, remplacez toutes les occurrences du mot-clé \<LIGUE\> de ce pouvoir (le cas échéant) par le nom de la Ligue de votre PSYKER.*

*La valeur de manifestation indiquée pour chaque pouvoir est le seuil à atteindre pour réussir l'action psychique.*

**1 – Interface Écho (Bénédiction, manifestation 5)**

  - Si l'action psychique est réussie, vous récupérez un Stratagème utilisé ce tour d'une valeur de 1 PC.

**2 – Fortifier (Bénédiction, manifestation 6)**

  - Si réussie, sélectionnez une unité \<LIGUE\> INFANTERIE, MARCHEUR ou MONTÉ ou \<LIGUE\> PERSONNAGE à 12" ou moins de ce PSYKER. Jusqu'à la prochaine phase d'Action :

  - Ajoutez 1 à la caractéristique d'Endurance des modèles de cette unité.

  - L'unité obtient la capacité [Insensible à la douleur 6+].

**3 – Courroux Ancestral (Feu de Sorcier, manifestation 6)**

  - Si réussie, sélectionnez une unité ennemie à 18" ou moins et visible de ce PSYKER, puis lancez 3D6. Si cette unité compte 11 modèles ou plus, lancez 6D6 à la place. Dans les deux cas, ajoutez 1 à chaque résultat si l'unité ennemie a 1 jeton de Jugement ou plus. Pour chaque résultat de 4+, elle subit 1 blessure mortelle.

**4 – Bûcher de Rancune (Feu de Sorcier, manifestation 4)**

  - Si réussie, sélectionnez une unité ennemie qui n'est ni VÉHICULE, ni MONSTRE, ni PERSONNAGE, à 18" ou moins et visible de ce PSYKER. Lancez 2D6 et retirez au résultat le nombre de jetons de Jugement de cette unité : si le résultat est inférieur à la caractéristique de Commandement non modifiée de l'unité, un modèle de cette unité choisi par votre adversaire est détruit.

**5 – Vortex Nul (Malédiction, manifestation 8)**

  - Si réussie, sélectionnez une unité ennemie à 12" ou moins de ce PSYKER. Jusqu'au début de la prochaine phase d'Action, les modèles de cette unité ne peuvent utiliser aucune sauvegarde invulnérable.

**6 – Mépris Écrasant (Malédiction, manifestation 6)**

  - Si réussie, sélectionnez une unité ennemie à 18" ou moins de ce PSYKER, puis lancez 3D6.

  - Si le résultat est inférieurs ou égal à la caractéristique de Commandement de l'unité, elle est considéré comme ayant fait son action.
...
*Une fois le Trait déterminé pour un modèle PERSONNAGE VOTANN, remplacez toutes les occurrences du mot-clé \<LIGUE\> dans son Trait (le cas échéant) par le nom de la Ligue de votre modèle.*

**1 – Prestance Ancestrale**

  - Lors de la phase de Commandement, chaque fois que ce SEIGNEUR DE GUERRE utilise une capacité précisant une portée, vous pouvez ajouter 3" à la portée de cette capacité (maximum 12").

  - Ajoutez 3" à la portée des capacités d'Aura de ce SEIGNEUR DE GUERRE (maximum 12").

**2 – Seigneur Guerrier**

  - Chaque fois que ce SEIGNEUR DE GUERRE effectue une attaque de mêlée, vous pouvez relancer le jet de blessure.

  - Chaque fois qu'une attaque de mêlée de ce SEIGNEUR DE GUERRE est allouée à un modèle ennemi, ce modèle ne peut utiliser aucune règle lui permettant d'ignorer les Blessures qu'il perd.

**3 – Une Longue Liste**

  - Chaque fois que ce SEIGNEUR DE GUERRE effectue une attaque à distance, la cible ne peut pas bénéficie du Couvert Léger contre cette attaque.

  - À la fin de chaque phase, si des unités ennemies avec des jetons de Jugement ont été détruites durant cette phase par une unité \<LIGUE\> de votre armée, sélectionnez une unité ennemie visible par ce SEIGNEUR DE GUERRE ; elle gagne 1 jeton de Jugement.

**4 – Affilié de Guilde**

  - Lors de la phase de Commandement, vous pouvez sélectionner une unité \<LIGUE\> INFANTERIE, MARCHEUR ou MONTÉ à 6" ou moins de ce SEIGNEUR DE GUERRE. Jusqu'au début de la prochaine phase de Commandement, cette unité a la capacité Objectif Sécurisé. Si un modèle de cette unité a déjà cette capacité, il double sa caractéristique OC.

**5 – Labeur Sans Fin (Aura)**

  - Tant qu'une unité \<LIGUE\> INFANTERIE, MARCHEUR ou MONTÉ qui effectue une action à 6" ou moins de ce SEIGNEUR DE GUERRE, cette unité peut qu'en même tirer.

**6 – Air Sévère (Aura)**

  - Tant qu'une unité \<LIGUE\> INFANTERIE, MARCHEUR ou MONTÉ est à 6" ou moins de ce SEIGNEUR DE GUERRE :
    
      - Cette unité peut ignorer tout ou une partie des modificateurs à sa caractéristique de Commandement.
...
**Patronage de Guilde (1 PR)**

  - Achetez cette Réquisition quand une unité VOTANN de votre armée gagne un rang. Cette unité gagne 5 points d'expérience et vous pouvez immédiatement utiliser la Réquisition « Réparer et Récupérer » sur elle sans coût supplémentaire en PR. Vous ne pouvez pas utiliser cette Réquisition plus d'une fois sur la même unité.

**Acquisition Rare (1 PR)**

  - Achetez cette Réquisition à la fin d'une bataille. Lancez 1D6, ajoutez 3 au résultat si vous avez gagné la bataille, et ajoutez encore 1 s'il y avait une ou plusieurs unités VOTANN Hearthkyn Warriors, Hernkyn Pioneers ou Hekaton Land Fortress de votre armée sur le champ de bataille à la fin de la bataille : sur 4+, vous gagnez 1 Amélioration d'arme aléatoire ; sur 10, vous gagnez 2 Améliorations d'armes aléatoires.

**Haine Dirigée (1 PR)**

  - Achetez cette Réquisition à tout moment. Sélectionnez une unité VOTANN de votre armée et une Faction. Cette unité entretient désormais une Rancune contre cette Faction (notez-le).

**Un Grand Honneur (1 PR)**

  - Achetez cette Réquisition quand une unité KÂHL, GRIMNYR ou BRÔKHYR IRON-MASTER de votre armée gagne le rang Endurci, Héroïque ou Légendaire. Cette unité est améliorée vers le Conseil Votannic (voir la section « Le Conseil Votannic ») ; notez-le. Vous ne pouvez pas acheter cette Réquisition si cela porterait le total de votre armée au-delà de sa Limite d'Approvisionnement.

**Mercenaires Impériaux (1 PR)**

  - Achetez cette Réquisition à tout moment. Vous pouvez ajouter à votre armée un Détachement de Support Auxiliaire composé d'unités AGENT DE L'IMPERIUM ou ASTRA MILITARUM ; ce Détachement de Support Auxiliaire ne coûte pas de PC (0 PC). Jusqu'à la fin de la campagne, les unités de ce détachement gagnent les mots-clés NON-ALIGNÉ (celui de votre armée), et toutes les unités VOTANN de votre armée gagnent le mot-clé AGENT DE L'IMPERIUM.

**Retour aux Ancêtres (1 PR)**
...
**AUCUN EFFORT GASPILLÉ (Agenda des Ligues de Votann)**

  - Tenez un registre « Zéro Déchet » pour chaque unité VOTANN de votre armée. Chaque fois qu'une telle unité détruit une unité ennemie :

  - Si cette unité ennemie avait 1 ou 2 jetons de Jugement, ajoutez 1 à son total Zéro Déchet.

  - Si cette unité ennemie avait 3 jetons de Jugement, ajoutez 2 à son total Zéro Déchet.

  - À la fin de la bataille, chaque unité gagne un nombre de points d'expérience égal à son score « Zéro Déchet » (maximum 3 points d'expérience par unité).

**ACQUISITION PRIORITAIRE (Agenda des Ligues de Votann)**

  - Si vous avez sélectionné cet Agenda, une fois le déploiement des deux camps terminé, votre adversaire place un marqueur dans une zone objectif à plus de 12" de sa zone de déploiement. Ce marqueur représente une Acquisition Prioritaire. Les unités VOTANN INFANTERIE de votre armée peuvent tenter l'action suivante.

  - Récupérer l'Acquisition (Action) : durant la phase d'Action, une unité VOTANN INFANTERIE de votre armée située dans la zone objectif du marqueur d'Acquisition Prioritaire peut commencer cette action si aucune unité ennemie (hors AÉRONEF) ne se trouve dans la zone objectif du marqueur. L'action se termine à la fin du tour de bataille. Si elle est terminée, retirez le marqueur d'Acquisition Prioritaire du champ de bataille.

  - Une unité gagne 3 points d'expérience si elle a terminé cette action. Si elle termine cette action et n'est pas détruite à la fin de la bataille, elle gagne aussi 1 Amélioration d'arme aléatoire. De plus, si cette unité est une unité Hearthkyn Warriors, vous pouvez relancer les dés pour déterminer cette Amélioration d'arme.

**RÉGLER UNE RIVALITÉ (Agenda des Ligues de Votann)**

  - Si vous avez choisi cet Agenda, tenez un registre « Règlement de Rancune » pour chaque unité VOTANN de votre armée nourrissant une Rancune contre la faction adverse. Ajoutez 1 à son score chaque fois qu'elle détruit une unité ennemie, et 1 de plus chaque fois qu'elle détruit une unité ennemie au corps à corps. À la fin de la bataille, chaque unité gagne un nombre de points d'expérience égal à son score « Règlement de Rancune » (maximum 3 points d'expérience par unité). Si une unité règle sa Rancune durant cette bataille, elle gagne 3 points d'expérience bonus.

**RÉVÉLATION ANCESTRALE (Agenda des Ligues de Votann)**

  - Si vous avez sélectionné cet Agenda, sélectionnez une unité GRIMNYR de votre armée et tenez un compteur « Prospection Psychique » pour cette unité. Ajoutez 1 à ce compteur chaque fois qu'elle réussit l'action psychique suivante.

  - Prospection Psychique (Action psychique, manifestation 3) : une unité GRIMNYR de votre armée peut tenter cette action psychique si elle se trouve à 6" ou moins de chaque bord de terrain. Cette action psychique ne peut être effectuée qu'une seule fois par bord de terrain.

  - À la fin de la bataille, cette unité gagne :

  - 1 point d'expérience si son total de Prospection Psychique est de 1.

  - 3 points d'expérience si son total est de 2.

  - 6 points d'expérience et une Force Psychique si son total est de 3.

## **Nourrir une Rancune**

*Au début de chaque bataille, si des unités VOTANN de votre armée nourrissent une Rancune envers l'armée adverse, lancez 1D6 pour chacune de ces unités : pour chaque 6, vous pouvez placer 1 jeton de Rancune à côté d'une unité ennemie, sur le champ de bataille ou en réserve. Un jeton de Rancune fonctionne comme un jeton de Jugement, à ceci près qu'il ne sert qu'à déterminer les bonus d'attaque d'une figurine attaquante qui nourrit une Rancune envers l'armée adverse.*

  - Chaque fois qu'un modèle d'une unité de votre armée qui nourrit une Rancune envers l'armée adverse effectue une attaque : si l'unité ciblée possède 1 ou 2 jetons de Rancune, relancez les jets de touche de 1 ; si elle possède 3 jetons de Rancune, vous pouvez relancer le jet de touche.

  - Une unité de votre armée qui nourrit une Rancune envers l'armée adverse ne peut pas effectuer d'action si elle se trouve à 6" ou moins d'une ou plusieurs unités ennemies, et ne peut pas se Désengager tant qu'elle se trouve à Portée d'Engagement d'une ou plusieurs unités ennemies.
...
**EINHYR HEARTHGUARD**
  ...
  - **1-2 Protecteurs inébranlables** : tant qu'une unité PERSONNAGE \<LIGUE\> se trouve à 3" ou moins de cette unité, les figurines ennemies ne peuvent pas cibler cette unité PERSONNAGE avec des attaques à distance.

  - **3-4 Exo-armure ancestrale** : cette unité obtient [Insensible à la douleur 5+] contre les Blessures mortelles.

  - **5-6 Héros de la Ligue** : vous pouvez jouer gratuitement le stratagème « La Puissance des Einhyr » sur cette unité.

**BRÔKHYR IRON-MASTER**

  - **1-3 Maître sauveteur** : si cette unité n'a pas été détruite pendant la bataille, à la fin de la bataille vous pouvez ignorer un test « Hors de Combat » raté effectué pour une unité VÉHICULE \<LIGUE\> ; ce test est alors considéré comme réussi.

  - **4-6 Assistante exceptionnelle** : ajoutez 2 aux caractéristiques d'Attaques, de Commandement et de Blessures du modèle IRONKIN ASSISTANT de cette unité.

**HERNKYN PIONEERS**

  - **1-2 Technologie magnétique avancée** : ajoutez 2" à la caractéristique de Mouvement des modèles de cette unité. De plus, vous pouvez jouer gratuitement le stratagème « Réponse Accélérée » sur cette unité.

  - **3-4 Assaut à plein régime** : toutes ses armes gagnent le mot-clé [ASSAUT].

  - **5-6 Course de mitrailleuse** : une fois par bataille, après que cette unité a résolu ses attaques de tir lors de la phase d'Action, elle peut effectuer un Mouvement Normal en plus.

**VOTANN (unités, hors VÉHICULE)**

  - **1 Efficacité inébranlable** : une fois par bataille, lors de la phase de Commandement, désignez une unité ennemie possédant au moins un jeton de Jugement comme « Cible désignée » de cette unité. Jusqu'au début de la prochaine phase de Commandement, chaque fois qu'un modèle de cette unité (hors modèle COG) effectue une attaque contre la Cible désignée, cette unité ennemie est considérée comme ayant 3 jetons de Jugement pour déterminer les bonus applicables.

  - **2 Têtue et impitoyable** : lorsqu'une unité acquiert ce Trait pour la première fois, vous pouvez immédiatement utiliser la Réquisition « Haine Dirigée » sur cette unité pour 0 PR. De plus, chaque fois qu'un modèle de cette unité effectue une attaque, si cette unité nourrit une Rancune contre l'armée adverse, vous pouvez relancer le jet de touche.

  - **3 Ingénieur** : une fois par tour de bataille, durant la phase d'action, après que cette unité a terminé son action, elle peut réparer une unité \<LIGUE\> VÉHICULE à 3" ou moins ; un modèle de cette unité récupère jusqu'à D3 Blessures perdues.

  - **4 Forgé par la guerre** : chaque fois qu'un test d'Ébranlement est effectué pour cette unité, il est automatiquement réussi. De plus, vous pouvez relancer les tests « Hors de Combat » ratés effectués pour cette unité.

  - **5 Nulllyn Cloneskein** : une fois par tour de bataille, cette unité peut tenter un Refus du Sorcier comme si elle était un PSYKER. Si cette unité est déjà un PSYKER, elle peut tenter un Refus du Sorcier supplémentaire lors de chaque phase d'Action adverse.
...
*Note de cohérence : section issue du système « Croisade ». « Croisade » a été remplacé par « armée » ; profils d'arme alignés sur la base (F = Force, PA = Pénétration d'Armure) ; « Wounds » → « Blessures » ; « Beam » → « Rayon (Beam) ». Restent à réconcilier avec notre système de campagne : les rangs (Héroïque, Légendaire), les points de Croisade, les points de Réquisition (PR), les tests « Hors de Combat », les ressources fondamentales et les Rancunes. À corriger ultérieurement.*
...
**Convertisseur Recyc**
  ...
  - Modèle équipé d'un désintégrateur volkanite, d'un blaster ion ou d'un fusil graviton uniquement (ou d'une Relique qui remplace une telle arme). Chaque fois que le porteur détruit une unité ennemie, à la fin de la bataille vous gagnez 1 PR pour chaque unité détruit par le porteur avec un désintégrateur volkanite, d'un blaster ion ou d'un fusil graviton uniquement (ou d'une Relique qui remplace une telle arme), max 3 PR par bataille.
...
**Éclat de Tôrek**
  ...
  - Jusqu'à la fin du tour, ajoutez 1 à la caractéristique d'Attaques des modèles des unités VOTANN qui étaient à 6" ou moins du porteur au moment où il a révélé la Relique.

  - Si toutes les unités de votre armée appartiennent à la même Ligue (hors modèles NON-ALIGNÉ), chaque unité ennemie à 18" ou moins du porteur gagne 1 jeton de Jugement.
