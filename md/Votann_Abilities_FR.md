...
*Une armée ne peut pas débuter avec des unités PERSONNAGE améliorées : pour en inclure une, utilisez la Réquisition « Un Grand Honneur ».*
...
**Patronage de Guilde (1 PR)**
  ...
  - Achetez cette Réquisition à la fin d'une bataille. Sélectionnez une unité de votre armée sur le champ de bataille. Lancez 1D6, ajoutez 3 au résultat si vous avez gagné la bataille, et ajoutez encore 1 s'il y avait une ou plusieurs unités VOTANN Hearthkyn Warriors, Hernkyn Pioneers ou Hekaton Land Fortress de votre armée sur le champ de bataille à la fin de la bataille : sur 4+, l'unité sélectionner gagne 1 Amélioration d'arme aléatoire ; sur 10, elle gagne 2 Améliorations d'armes aléatoires.
...
**AUCUN EFFORT GASPILLÉ**
  ...
  - Si vous avez sélectionné cet Agenda, une fois le déploiement des deux camps terminé, votre adversaire choisit une zone d'objectif à plus de 12" de sa zone de déploiement. Cette zone d'objectif représente une Acquisition Prioritaire. Les unités VOTANN INFANTERIE de votre armée peuvent tenter l'action suivante.

  - Récupérer l'Acquisition (Action) : durant la phase d'Action, une unité VOTANN INFANTERIE de votre armée située dans la zone d'objectif d'Acquisition Prioritaire peut commencer cette action si aucune unité ennemie (hors AÉRONEF) ne se trouve dans la zone d'objectif. L'action se termine à la fin du tour de bataille. Si elle est terminée, la zone d'objectif n'est plus une Acquisition Prioritaire.
...
**EINHYR HEARTHGUARD**
  ...
  - **1-2 Protecteurs inébranlables** : tant qu'une unité PERSONNAGE \<LIGUE\> se trouve à 3" ou moins de cette unité, les modèles ennemis ne peuvent pas cibler cette unité PERSONNAGE avec des attaques à distance.
