...
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Port Spatial**           | Adapté aux armées d'élite : facilite le contrôle des objectifs et permet aux unités de se replier sans être piégées par des forces plus nombreuses. | Bâtiments hauts et ruines, largement espacés avec des espaces suffisants pour les VEHICULES.                                                                 |
| **Terres Désolées**        | Adapté aux armées d'infanterie et de cavalerie : déploiement agressif et repositionnement facilités.                                                | Décors de type ZONE TERRAIN peu encombrants, dispersés dans le No Man's Land pour marquer une région sauvage et dépeuplée.                                   |
| **Jungle Xenoflore**       | Booste les armées de mêlée : plus de dégâts, protection contre les tirs, et punition des unités qui se replient.                                    | Mélange de bois et de ruines couvertes de végétation, bien répartis sur le champ pour refléter la densité florale.                                           |
| **Zone de Radiation**      | Adapté au jeu d'attrition : réduit la létalité et améliore la durabilité des unités.                                                                | Des hauteurs de cote pour limiter la visibilité.                                                                                                             |
| **Complexe de Forges**     | Booste les unités robustes et durables.                                                                                                             | De nombreux décors OBSTACLE, des tuyaux industriels, des machines représentant les lignes de fabrication et des sanctuaires de forge toujours opérationnels. |
| **Quartiers Résidentiels** | Booste les unités dans les ZONES TERRAIN : survie ou létalité augmentées.                                                                           | Couverture épaisse de décors ZONE TERRAIN, en grande partie des ruines, réparties assez uniformément sur le champ.                                           |
| **Installation Minière**   | Booste les attaques contre les unités coriaces.                                                                                                     | Tuyaux, réservoirs, barils, barrières et structures du Secteur Frontiéris constituant l’infrastructure minière.                                              |
...
**Avantages tactiques : adapté aux armées d'élite ; facilite le contrôle des zones d'objectif et permet aux unités de se désengager sans être piégées par des forces plus nombreuses.**

| **D6**  | **Nom du Twist**                | **Effet**                                                                                                                                                                                                        |
| ------- | ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1-2** | **Verrouillage de Coordonnées** | Toutes les unités des deux armées gagnent la capacité Objectif Sécurisé.                                                                                                                                         |
...
**Avantages tactiques :** adapté aux armées d'infanterie et de cavalerie : déploiement agressif et repositionnement facilités.

| **D6**  | **Nom du Twist**        | **Effet**                                                                                                                                                                                                                                                                                                                    |
| ------- | ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1-2** | **Terrain ouvert**      | Ajoutez 2" aux mouvements d'Avance et aux jets de Charge des unités (hors MONSTRE et VÉHICULE).                                                                                                                                                                                                                              |
...
**Avantages tactiques :** booste les armées de mêlée : plus de dégâts, protection contre les tirs, et punition des unités qui se replient.

| **D6**  | **Nom du Twist**      | **Effet**                                                                                                                                                                                                   |
| ------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1-2** | **Spores de carnage** | La caractéristique de Force des armes de mêlée de tous les modèles est augmentée de 1.                                                                                                                      |
...
**Avantages tactiques :** adapté au jeu d'attrition : réduit la létalité et améliore la durabilité des unités.

| **D6**  | **Nom du Twist**                | **Effet**                                                                                                                       |
| ------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| **1-2** | **Tempête de cendres toxiques** | Tour de bataille 2 : la portée maximale des attaques à distance est de 18". Tour de bataille 3 : 12". Tour de bataille 4 : 18". |
...
**Avantages tactiques :** booste les unites robustes et durables. Les unités nombreuses et légèrement blindees subiront des dégâts accrus.

| **D6**  | **Nom du Twist**          | **Effet**                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ------- | ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1-2** | **Corrosion thermique**   | Chaque attaque contre une unité ennemie (hors MONSTRE et VÉHICULE) à 9" ou moins bénéficie de +1 PA.                                                                                                                                                                                                                                                                                                                                                 |
...
**Avantages tactiques :** booste les unités dans les ZONES TERRAIN : survie ou létalité augmentées.

| **D6**  | **Nom du Twist**         | **Effet**                                                                                                                 |
| ------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| **1-2** | **Fumées suffocantes**   | Tant qu'un modèle est entièrement dans une ZONE TERRAIN, il possède la capacité Discrétion.                               |
...
**Avantages tactiques :** booste les attaques contre les unités coriaces. Des explosifs récupérés aident les unités faibles à abattre des adversaires imposants.

| **D6**  | **Nom du Twist**          | **Effet**                                                                                                                                                                              |
| ------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1-2** | **Détonations minières**  | Chaque attaque contre une unité d'Endurance 7 ou plus bénéficie de +1 au jet de blessure.                                                                                              |
...
**Avantages tactiques :** booste les MONSTRES et VÉHICULES : vitesse, durabilité et létalité augmentées.

| **D6**  | **Nom du Twist**          | **Effet**                                                                                                                                                         |
| ------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1-2** | **Vaste désolation**      | \+3" au Mouvement des unités MONSTRE et VÉHICULE.                                                                                                                 |
...
**Avantages tactiques :** imprévisible, ne favorise pas une armée en particulier mais génère des batailles variées et surprenantes.

| **D6**  | **Nom du Twist**                 | **Effet**                                                                                                                                                                                          |
| ------- | -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1-2** | **Compression spatiotemporelle** | Ajoutez 2" aux mouvements d'Avance.                                                                                                                                                                |
| **3-4** | **Énergies submergeantes**       | Quand une unité est sélectionnée pour tirer ou combattre, elle peut activer cette règle : jusqu'à la fin de la phase, +2 à la Force de toutes ses armes, mais celles-ci gagnent **[DANGEREUX]**. |
| **5-6** | **Bouclier quantique**           | Tous les modèles ont une sauvegarde invulnérable de 5+ contre les attaques à distance.                                                                                                             |
