...
- Cette unité ne peut jamais avoir de Trait de Seigneur de Guerre.
- Au déploiement, vous pouvez placer cette unité en réserve au lieu de la déployer. Elle entre alors en jeu par **Frappe en Profondeur**.

*(Note : s'assurer que les fiches d'unité concernées disposent bien de la règle **Frappe en Profondeur**.)*
